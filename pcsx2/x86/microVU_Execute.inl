...
void mVUdispatcherAB(mV)
{
	...
	Perf::any.map((uptr)mVU.startFunct, static_cast<u32>(xGetPtr() - mVU.startFunct),
...
void mVUdispatcherCD(mV)
{
	...
	Perf::any.map((uptr)mVU.startFunctXG, static_cast<u32>(xGetPtr() - mVU.startFunctXG),
...
void mvuGenerateWaitMTVU(mV)
{
	...
	Perf::any.map((uptr)mVU.waitMTVU, static_cast<u32>(xGetPtr() - mVU.waitMTVU),
...
void mvuGenerateCopyPipelineState(mV)
{
	...
	Perf::any.map((uptr)mVU.copyPLState, static_cast<u32>(xGetPtr() - mVU.copyPLState),
