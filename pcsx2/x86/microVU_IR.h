...
struct alignas(16) microBlock
{
	...
	u8* x86ptrValidate; // Start of code, with validation checks for indirect branches
	void** jumpCache; // Will point to an array of entry points of size [16k/8] if block ends in JR/JALR
};
