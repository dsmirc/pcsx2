...
public:
	...
	enum : u32
	{
		...
		TFX_ROOT_SIGNATURE_PARAM_PS_UAVS = 6,
...
private:
	...
	ComPtr<ID3D12PipelineState> m_rov_depth_begin_pipeline;
...
public:
	...
	void PSSetUAV(u32 index, GSTexture* uav);
...
private:
	enum DIRTY_FLAG : u32
	{
		...
		DIRTY_FLAG_UAV_DESCRIPTOR_TABLE = (1 << 12),
		...
		DIRTY_BASE_STATE = DIRTY_FLAG_VS_CONSTANT_BUFFER_BINDING | DIRTY_FLAG_PS_CONSTANT_BUFFER_BINDING |
						   ...
						   DIRTY_FLAG_UAV_DESCRIPTOR_TABLE | DIRTY_FLAG_VERTEX_BUFFER | DIRTY_FLAG_INDEX_BUFFER |
						   DIRTY_FLAG_PRIMITIVE_TOPOLOGY | DIRTY_FLAG_VIEWPORT | DIRTY_FLAG_SCISSOR |
						   DIRTY_FLAG_RENDER_TARGET | DIRTY_FLAG_PIPELINE | DIRTY_FLAG_BLEND_CONSTANTS |
						   DIRTY_FLAG_STENCIL_REF,

		DIRTY_TFX_STATE = DIRTY_BASE_STATE | DIRTY_FLAG_TFX_TEXTURES | DIRTY_FLAG_TFX_SAMPLERS |
						  DIRTY_FLAG_TFX_RT_TEXTURES | DIRTY_FLAG_TFX_UAVS,
	...
	std::array<D3D12DescriptorHandle, NUM_TFX_UAVS> m_tfx_uavs{};
	...
	D3D12DescriptorHandle m_tfx_uav_handle_gpu;
